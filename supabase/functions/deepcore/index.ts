...
const RPC_BY_ACTION: Record<string, { name: string; args?: (body: any) => Record<string, unknown> }> = {
  ...
  setAutoContribute: { name: "deepcore_set_auto_contribute", args: (b) => ({ p_enabled: Boolean(b.enabled), p_min_rarity: b.minRarity ?? 1, p_max_rarity: b.maxRarity ?? null, p_max_value: b.maxValue ?? null }) },
