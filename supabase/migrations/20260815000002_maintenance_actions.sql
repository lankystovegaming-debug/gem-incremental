-- =========================================================
-- Maintenance layer: two more actions.
--
--   capacity  → add inventory slots to a player
--   rolls     → add to a player's total_rolls (shows on the
--               Total Rolls leaderboard)
--
-- Everything else is unchanged. This CREATE OR REPLACE carries
-- the whole function so it stays a single source of truth; the
-- gate (code_improvement allow-list) and target resolution are
-- identical to the original.
-- =========================================================

-- The base game tables are not tracked in this repo, so on a fresh
-- preview / CI database they do not exist yet — disable body
-- validation, exactly as the original migration does.
