-- Extend the referral LAUNCH PROMO from "end of Sept 5" to "end of Sept 13"
-- (2026). Only the cutoff instant changes; rewards, qualification, and the
-- safety shape are identical to 20260831040000_referral_launch_promo.
...
declare
  ...
  -- Inclusive of all of Sept 13 (UTC); the offer closes at this instant.
  v_promo_ends timestamptz := '2026-09-14 00:00:00+00';
