-- =========================================================
-- Faster idle market-price decay.
--
-- Reduce the no-buy half-life from 24 hours to 6 hours. Every six
-- hours without a new buy now halves the remaining distance to $1.
-- =========================================================
