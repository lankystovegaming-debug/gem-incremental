-- =========================================================
-- Market balanced-profit retune.
--
-- Profits should be possible when other players genuinely move the
-- price after a player buys. Keep the no-drift invariant from the
-- previous hardening, but use a 1% spread and a steeper bounded curve
-- so real demand can produce modest gains without any free recovery.
-- =========================================================
...
begin
  ...
  -- The price can only move when another real trade moves this curve.
  select price
  into v_price
