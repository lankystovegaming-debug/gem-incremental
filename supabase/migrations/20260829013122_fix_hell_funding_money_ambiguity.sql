-- Qualify the players.money column and avoid colliding with PL/pgSQL variable
-- names. The previous function raised PostgreSQL 42702 before funding D1.
...
begin
  ...
  update public.abandoned_mine_runs set
    ...
    danger=greatest(0,coalesce((v_state->>'dangerFloor')::integer,0)),
    status='active',
    hell_state=v_state,
