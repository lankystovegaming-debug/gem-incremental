...
assert.match(improvements,/unique index abandoned_mine_funding_overdepth_once/);assert.match(html,/View Loot Table/);assert.match(html,/lootTableDialog/);assert.match(page,/Descend free/);assert.match(page,/The descent is free/);assert.match(page,/Danger:[\s\S]*projectedDanger/);assert.match(page,/incident can occur during entry/);assert.doesNotMatch(page,/money<dashboard\.nextOverdepthCost/);
