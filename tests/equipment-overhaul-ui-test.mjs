...
const stubs={
 ...
 '/src/backend/supabase.js':'const result=Promise.resolve({data:[],error:null});const chain={select(){return chain},eq(){return chain},then(resolve,reject){return result.then(resolve,reject)}};export const supabase={from(){return chain}};',
