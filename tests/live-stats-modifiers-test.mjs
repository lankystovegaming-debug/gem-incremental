...
assert.match(stats, /research:researchLuckMultiplier/);
...
assert.doesNotMatch(stats, /masterwork_passive === "fortune_walker"/);
...
assert.match(roll, /research: researchNumber\("luck_multiplier"\)/);
