...
const batchBands={Common:[1,9],Uncommon:[10,49],Rare:[50,99],Epic:[100,999],Legendary:[1000,9999],Mythic:[10000,99999],Exotic:[100000,999999],Exalted:[1000000,9999999],Cosmic:[10000000,99999999]};
...
export const fiveItemRecipes=[
 ...
 pick('all-in-pickaxe','All-In Pickaxe',500000000,[...batchBulk('all-in-pickaxe',{Legendary:7500,Mythic:2000,Exotic:150,Exalted:20,Cosmic:3}),lifetimeRolls(100000),history('endgamePickaxes',5,'Distinct post-Celestial endgame Pickaxes ever owned'),history('raw10m',3,'Historical base-rarity ≥1/10M rolls')]),
 ...
 {...pick('jackpot-slot','Jackpot Slot',77700000,[...batchBulk('jackpot-slot',{Common:7777,Mythic:777,Exotic:77,Exalted:7}),lifetimeRolls(77700)],true),description:'Slots slots slots, I bet everything on slots. Ain’t no body taking my spot, I just hit the jackpotttt'},
  ...
  if(PICKAXE_STATS[r.id]) {
   ...
   if(['empyrean-pickaxe','eternity-pickaxe'].includes(r.id)) {
    ...
    r.requirements=r.requirements.map(q=>q.type==='lifetime-rolls'
     ? lifetimeRolls(emp?250000:300000)
